        ...
        <div className="col-lg-10 col-md-9 col-xl-6 mx-auto ms-xl-0">
          ...
          <form>
            <div className="mb-5">
              ...
              <input type="email" className="form-control form-control-muted" id="email"/>
            </div>
            <div className="mb-5">
              <label className="form-label" >Password</label>
              <input type="password" className="form-control form-control-muted" id="password" />
            </div>
            <div className="mb-5">
          ...
          <div className="my-6">
            ...
            <a href="#" className="text-warning text-sm font-semibold">Sign up</a>
          </div>
        </div>
      </div>
    </div>
